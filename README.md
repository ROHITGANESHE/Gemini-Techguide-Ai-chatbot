...
TechGuide Pro is a domain-specific, production-grade GenAI chatbot designed to assist users with high-level technical knowledge. It leverages Google's Gemini API (1.5 Flash) and is built with a modular, stateless architecture suitable for real-world deployment on cloud platforms like AWS EC2.
